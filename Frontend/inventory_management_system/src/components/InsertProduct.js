...
export default function InsertProduct() {
    ...
    const setPrice = (e) => {
        ...
        setProductPrice(formattedPrice.replace("₹", "")); // Store only numeric part
    };
    ...
    const addProduct = async (e) => {
        ...
        try {
            const res = await fetch("https://inventory-management-system-0nxu.onrender.com/insertproduct", {
                method: "POST",
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    ProductPrice: productPrice.replace(/,/g, ""), // Remove commas for the backend
