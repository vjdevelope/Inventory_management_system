...
export default function InsertProduct() {
    ...
    useEffect(() => {
        const getProduct = async () => {
          try {
            const res = await fetch(`https://inventory-management-system-0nxu.onrender.com/products/${id}`, {
              method: "GET",
              headers: {
    ...
    const updateProduct = async (e) => {
        ...
        try {
            const response = await fetch(`https://inventory-management-system-0nxu.onrender.com/updateproduct/${id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
